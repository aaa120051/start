  ...
  return (
    <div className="ps-4 pt-11 lg:pt-20 xl:ps-0 text-black">
      ...
      <div className="flex h-[70px] gap-12 items-center overflow-x-auto scrollbar-hide">
        <img
          src="/src/assets/partners/rst.png"
          alt="rst"
          width={85}
          height={70}
        ...
        />
        <img
          src="/src/assets/partners/ator.png"
          alt="ator"
          width={72}
          height={63}
        ...
        />
        <img
          src="/src/assets/partners/tkp.png"
          alt="tkp"
          width={183}
          height={52}
        ...
        />
        <img
          src="/src/assets/partners/alphabank.png"
          alt="alphabank"
          width={150}
          height={62}
        ...
        />
        <img
          src="/src/assets/partners/iata.png"
          alt="iata"
          width={163}
          height={62}
        ...
        />
        <img
          src="/src/assets/partners/BSIGlobal.png"
          alt="BSIGlobal"
          width={167}
          height={45}
